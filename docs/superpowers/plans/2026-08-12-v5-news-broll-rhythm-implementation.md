...
- [x] **Step 1: 运行ffprobe并验证流属性**

Expected: 视频和音频属性满足Global Constraints。

- [x] **Step 2: 检查黑帧、静音和解码错误**
...
- [x] **Step 4: 导出最后4秒音频并检查完整收尾**

Expected: 音频尾部与主音频一致，最后有效人声后保留自然静音，不截词。

- [x] **Step 5: 生成SHA-256和QC报告**
...
- [x] **Step 1: 按设计文档逐项复核10条验收标准**

Expected: 所有要求有对应文件或命令输出证明。

- [x] **Step 2: 确认V4哈希未因本次工作变化**

Expected: V4现有成片保持不变。

- [x] **Step 3: 提交可追踪的小型制作元数据**
